                        ...
                        <table class="table table-sm table-borderless text-white" id="table-kas">
                            ...
                            <tbody id="body-kas">
                                <tr>
                                    ...
                                    <td>
                                        <input name="pemasukkan[]" class="form-control money" type="number" placeholder="Masukkan Jumlah">
                                    </td>
                                    <td>
        ...
        var count = document.getElementById("table-kas").getElementsByTagName("tr").length;
            if(count <= maxTr){
                ...
                <tr>
                    ...
                    <td>
                        <input name="pemasukkan[]" class="form-control money" type="number" data-kas="masuk" placeholder="Masukkan Jumlah">
                    </td>
                    <td class="align-middle text-center">
                        <button type="button" class="btn-dang btn-sm delete text-white" onclick="return this.parentNode.parentNode.remove()"><i class='bx bx-trash'></i></button>
                    </td>
                </tr>
                `;
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    if(json.hasOwnProperty('status')){
                        location.href='/flash?status='+json.status+'&messages='+json.messages
                    }else {
